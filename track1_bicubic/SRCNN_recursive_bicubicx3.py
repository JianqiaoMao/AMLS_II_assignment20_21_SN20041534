...
#%% Model save and load
SRCNN.save(r"/home/uceejm3/AMLS2/project/saved_models/IUD_srcnn_bicubicX3.h5")
print("model has saved")

from tensorflow.keras.models import load_model
SRCNN = load_model(r'/home/uceejm3/AMLS2/project/good_models/bicubic/IUD_srcnn_bicubicX3.h5',custom_objects={'PSNR_cal': PSNR_cal, 'SSIM_cal':SSIM_cal})
print("model loaded!")
