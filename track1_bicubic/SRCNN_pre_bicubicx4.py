...
#%% Model save and load
SRCNN.save(r"/home/uceejm3/AMLS2/project/saved_models/pre_srcnn_bicubicx4.h5")
print("model has saved")

from tensorflow.keras.models import load_model
SRCNN = load_model(r'/home/uceejm3/AMLS2/project/good_models/bicubic/pre_srcnn_bicubicx4.h5',custom_objects={'PSNR_cal': PSNR_cal, 'SSIM_cal':SSIM_cal})
print("model loaded!")
...
train_PSNR, train_SSIM, train_PSNR_list, train_SSIM_list = evaluation(train_HR_eval_paths,train_bicubic4_paths,model=SRCNN)
...
val_PSNR, val_SSIM, val_PSNR_list, val_SSIM_list = evaluation(val_HR_eval_paths,val_bicubic4_paths,model=SRCNN)
...
test_PSNR,test_SSIM, test_PSNR_list, test_SSIM_list = evaluation(test_HR_paths,test_bicubic4_paths,model=SRCNN)
exp_index=[22,61,79]
write_example(test_HR_paths, test_bicubic4_paths, model=SRCNN, exp_index=exp_index, write_path=r"/home/uceejm3/exp/")
