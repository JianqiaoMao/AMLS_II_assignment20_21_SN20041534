...
trainVal_bicubic2_paths = glob.glob(r"/home/uceejm3/AMLS2/project/processed_ds/training/bicubic/X2/*")
...
train_bicubic2_paths = trainVal_bicubic2_paths[:train_size]
...
val_bicubic2_paths = trainVal_bicubic2_paths[-val_size:]
...
#%% Model save and load
fdsrcnn.save(r"/home/uceejm3/AMLS2/project/saved_models/bicubic/FDSRCNN_bicubicX2.h5")
print("model has saved")

from tensorflow.keras.models import load_model
fdsrcnn = load_model(r'/home/uceejm3/AMLS2/project/good_models/bicubic/FDSRCNN_bicubicX2.h5',custom_objects={'PSNR_cal': PSNR_cal, 'SSIM_cal':SSIM_cal})
print("model loaded!")
...
trainVal_bicubic2_eval_paths = sorted(glob.glob(r"/home/uceejm3/AMLS2/project/dataset/training_set/bicubic/X2/*"), reverse=True)
...
train_bicubic2_paths = trainVal_bicubic2_eval_paths[:train_eval_size]
train_PSNR, train_SSIM, train_PSNR_list, train_SSIM_list = evaluation(train_HR_eval_paths,train_bicubic2_paths,model=fdsrcnn)
...
val_bicubic2_paths = trainVal_bicubic2_eval_paths[-val_eval_size:]
val_PSNR, val_SSIM, val_PSNR_list, val_SSIM_list = evaluation(val_HR_eval_paths,val_bicubic2_paths,model=fdsrcnn)
...
test_bicubic2_paths = sorted(glob.glob(r"/home/uceejm3/AMLS2/project/dataset/test_set/bicubic/X2/*"), reverse=True)

test_PSNR,test_SSIM, PSNR_list, SSIM_list = evaluation(test_HR_paths,test_bicubic2_paths,model=fdsrcnn)
exp_index=[22,61,79]
write_example(test_HR_paths, test_bicubic2_paths, model=fdsrcnn, exp_index=exp_index, write_path=r"/home/uceejm3/exp/")
