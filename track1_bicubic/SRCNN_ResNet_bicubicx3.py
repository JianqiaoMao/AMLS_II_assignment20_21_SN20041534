...
#%% Model save and load
fdsrcnn.save(r"/home/uceejm3/AMLS2/project/saved_models/bicubic/FDSRCNN_bicubicX3.h5")
print("model has saved")

from tensorflow.keras.models import load_model
fdsrcnn = load_model(r'/home/uceejm3/AMLS2/project/good_models/bicubic/FDSRCNN_bicubicX3.h5',custom_objects={'PSNR_cal': PSNR_cal, 'SSIM_cal':SSIM_cal})
print("model loaded!")
...
train_PSNR, train_SSIM, train_PSNR_list, train_SSIM_list = evaluation(train_HR_eval_paths,train_bicubic3_paths,model=fdsrcnn)
...
val_PSNR, val_SSIM, val_PSNR_list, val_SSIM_list = evaluation(val_HR_eval_paths,val_bicubic3_paths,model=fdsrcnn)
...
test_PSNR,test_SSIM, PSNR_list, SSIM_list = evaluation(test_HR_paths,test_bicubic3_paths,model=fdsrcnn)
exp_index=[22,61,79]
write_example(test_HR_paths, test_bicubic3_paths, model=fdsrcnn, exp_index=exp_index, write_path=r"/home/uceejm3/exp/")
