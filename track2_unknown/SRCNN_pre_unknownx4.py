...
def CNN():
    ...
    model.add(Conv2DTranspose(32, (9,9), activation = 'relu', strides=(2,2), padding='same', input_shape=(None,None,3)))
    ...
    model.add(Conv2DTranspose(64, (5,5), activation = 'relu', strides=(2,2), padding='same'))
    model.add(Conv2D(128, (3,3), padding='same', activation='relu'))
    model.add(Conv2D(64, (1,1), activation = 'relu', padding='same'))
    model.add(Conv2D(64, (5,5), padding='same', activation='relu')) 
    model.add(Conv2D(3, (3,3), padding='same', activation='sigmoid'))
...
def write_example(HR_paths, LR_paths, model, exp_index=None, write_path=r"/home/uceejm3/exp/"):
    ...
    for i in exp_index:
        ...
        cv2.imwrite(write_path+"SR_X4_pre_SRCNN_"+str(i)+"_PSNR"+str(PSNR_SR)+"_SSIM"+str(SSIM_SR)+".jpg",SR_exp*255.)  
...
#%% Model save and load
SRCNN.save(r"/home/uceejm3/AMLS2/project/saved_models/IUD_srcnn_unknownx4.h5")
print("model has saved")

from tensorflow.keras.models import load_model
SRCNN = load_model(r'/home/uceejm3/AMLS2/project/good_models/unknown/pre_srcnn_unknownx4.h5',custom_objects={'PSNR_cal': PSNR_cal, 'SSIM_cal':SSIM_cal})
print("model loaded!")
...
train_PSNR, train_SSIM, train_PSNR_list, train_SSIM_list = evaluation(train_HR_eval_paths,train_unknown4_paths,model=SRCNN)
...
val_PSNR, val_SSIM, val_PSNR_list, val_SSIM_list = evaluation(val_HR_eval_paths,val_unknown4_paths,model=SRCNN)
...
test_PSNR,test_SSIM, test_PSNR_list, test_SSIM_list = evaluation(test_HR_paths,test_unknown4_paths,model=SRCNN)
exp_index=[22,61,79]
write_example(test_HR_paths, test_unknown4_paths, model=SRCNN, exp_index=exp_index, write_path=r"/home/uceejm3/exp/")
