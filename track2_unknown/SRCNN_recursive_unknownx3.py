...
def write_example(HR_paths, LR_paths, model, exp_index=None, write_path=r"/home/uceejm3/exp/"):
    ...
    for i in exp_index:
        ...
        cv2.imwrite(write_path+"SR_X3_IUD_SRCNN_"+str(i)+"_PSNR"+str(PSNR_SR)+"_SSIM"+str(SSIM_SR)+".jpg",SR_exp*255.)  
...
#%% Model save and load
SRCNN.save(r"/home/uceejm3/AMLS2/project/saved_models/IUD_srcnn_unknownX3.h5")
print("model has saved")

from tensorflow.keras.models import load_model
SRCNN = load_model(r'/home/uceejm3/AMLS2/project/good_models/unknown/IUD_srcnn_unknownX3.h5',custom_objects={'PSNR_cal': PSNR_cal, 'SSIM_cal':SSIM_cal})
print("model loaded!")
