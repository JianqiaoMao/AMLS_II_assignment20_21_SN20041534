...
def write_example(HR_paths, LR_paths, model, exp_index=None, write_path=r"/home/uceejm3/exp/"):
    ...
    for i in exp_index:
        ...
        cv2.imwrite(write_path+"LR_X2_"+str(i)+"_PSNR"+str(PSNR_BIC)+"_SSIM"+str(SSIM_BIC)+".jpg", LR_BIC*255.)
        cv2.imwrite(write_path+"SR_X2_FDSRCNN_"+str(i)+"_PSNR"+str(PSNR_SR)+"_SSIM"+str(SSIM_SR)+".jpg",SR_exp*255.)   
...
trainVal_unknown2_paths = glob.glob(r"/home/uceejm3/AMLS2/project/processed_ds/training/unknown/X2/*")
...
train_unknown2_paths = trainVal_unknown2_paths[:train_size]
...
X2path_tr_ds = tf.data.Dataset.from_tensor_slices(train_unknown2_paths)
...
val_unknown2_paths = trainVal_unknown2_paths[-val_size:]
...
X2path_val_ds = tf.data.Dataset.from_tensor_slices(val_unknown2_paths)
...
#%% Model save and load
fdsrcnn.save(r"/home/uceejm3/AMLS2/project/saved_models/unknown/FDSRCNN_unknownX2.h5")
print("model has saved")

from tensorflow.keras.models import load_model
fdsrcnn = load_model(r'/home/uceejm3/AMLS2/project/good_models/unknown/FDSRCNN_unknownX2.h5',custom_objects={'PSNR_cal': PSNR_cal, 'SSIM_cal':SSIM_cal})
print("model loaded!")
...
trainVal_unknown2_eval_paths = sorted(glob.glob(r"/home/uceejm3/AMLS2/project/dataset/training_set/unknown/X2/*"), reverse=True)
...
train_unknown2_paths = trainVal_unknown2_eval_paths[:train_eval_size]
train_PSNR, train_SSIM, train_PSNR_list, train_SSIM_list = evaluation(train_HR_eval_paths,train_unknown2_paths,model=fdsrcnn)
...
val_unknown2_paths = trainVal_unknown2_eval_paths[-val_eval_size:]
val_PSNR, val_SSIM, val_PSNR_list, val_SSIM_list = evaluation(val_HR_eval_paths,val_unknown2_paths,model=fdsrcnn)
...
test_unknown2_paths = sorted(glob.glob(r"/home/uceejm3/AMLS2/project/dataset/test_set/unknown/X2/*"), reverse=True)

test_PSNR,test_SSIM, PSNR_list, SSIM_list = evaluation(test_HR_paths,test_unknown2_paths,model=fdsrcnn)
exp_index=[22,61,79]
write_example(test_HR_paths, test_unknown2_paths, model=fdsrcnn, exp_index=exp_index, write_path=r"/home/uceejm3/exp/")
